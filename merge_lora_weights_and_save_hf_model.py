...
from model.HumanGPT import HumanGPTForCausalLM
...
def main(args):
    ...
    model_args = {
        ...
        "cat_image_embeds": args.cat_image_embeds,
        "use_vitpose": args.use_vitpose,
    }
    ...
    model = HumanGPTForCausalLM.from_pretrained(
