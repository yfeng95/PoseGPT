...
def standard_rasterize_func(vertices, faces, attributes=None, image_size=512):
...
# For visualization
def render_shape(vertices, faces, image_size, background=None, lights=None, shift=True, colors=None):
    '''
    ...
    attributes = torch.cat([face_colors, 
                    ...
                    -1)
    # rasterize
    rendering = standard_rasterize_func(transformed_vertices, faces, image_size=image_size, attributes=attributes)
    ##
